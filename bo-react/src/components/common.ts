...
// BElement 表示 API 只接受传入组件
export type BElement<T = undefined> = T extends undefined ? ReactElement : (props: T) => ReactElement;
// 1. BNode = ReactNode; 2. BNode<T> = (props: T) => ReactNode
export type BNode<T = undefined> = T extends undefined ? ReactNode : ReactNode | ((props: T) => ReactNode);
...
/**
 * @deprecated use BScroll instead
 */
export type InfinityScroll = BScroll;
